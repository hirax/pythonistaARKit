...
def altimeterHandler(_cmd, _data, _error):
    global relativeAltitude, initialRA
    relativeAltitude = ObjCInstance(_data).relativeAltitude().floatValue()
    if initialRA is None:
        initialRA = relativeAltitude
    relativeAltitude = relativeAltitude - initialRA
...
if __name__ == '__main__':
    ...
    def createNodeElementInfo():
        return 'arrow', [relativeAltitude, 0.5, 1.0-relativeAltitude, 0.8], 0.2, 0.05+relativeAltitude*0.5, gRotation
